 ...
 /* $.fn.dataTableExt.oSort['chinese-desc'] = function(x, y) {
  ...
  $(function() {
    ...
    // "ajax": "json/article.json", //数据的路径
        "ajax": "/backstage/showarticlelist", //数据的路径
        ...
        "columns": [{ //定义列
          ...
          "data": function(obj) {
            return replaceTime(obj.creatTime / 1000);
          },
          "sTitle": "发布时间", //标题
          "sDefaultContent": "", //此列默认值为""，以防数据中没有此值，DataTables加载数据的时候报错  
        }, {
            "data": function(obj) {
                return replaceTime(obj.updateTime / 1000);
              },
              "sTitle": "更新时间", //标题
              "sDefaultContent": "", //此列默认值为""，以防数据中没有此值，DataTables加载数据的时候报错  
            }, 
     ...
     * 其他
     */
    $.fn.dataTable.Buttons.swfPath = "lib/dataTables/extensions/Buttons/swf/flashExport.swf";
